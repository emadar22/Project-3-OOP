...
OOP_Hw3::SubtractFunction::SubtractFunction(const SharedPtr<OOP_Hw3::Function> f1,
                                            const SharedPtr<OOP_Hw3::Function> f2) :func1(f1),func2(f2){
...
double OOP_Hw3::SubtractFunction::Evaluate(const map<string, double> &variables) const {
    return func1->Evaluate(variables)-func2->Evaluate(variables);
}
SharedPtr<OOP_Hw3::Function> OOP_Hw3::SubtractFunction::DeriveBy(const string &variable) const {
    SharedPtr<Function> dptr=new SubtractFunction(func1->DeriveBy(variable),func2->DeriveBy(variable));
    return dptr;
}
map<string,map<string,SharedPtr<OOP_Hw3::Function> > > OOP_Hw3::SubtractFunction::Hessian() const {
